...
public class BillAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String result = billObj.insertBill(
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 Map<String, String> param = getParasMap(request);
			...
			String result = billObj.updateBill(
					param.get("hidBillIDSave").toString(),
					param.get("uname").toString().toString().replace("+", " "),
					param.get("distID").toString().toString().replace("+", " "),     
					param.get("date").toString().toString().replace("+", " "), 
			 		param.get("reading").toString().toString().replace("+", " ") );
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 Map<String, String> param = getParasMap(request);
			...
			String result = billObj.deleteBill(param.get("billID").toString());
